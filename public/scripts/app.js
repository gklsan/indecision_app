...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function render() {
            var subtitle = 'This is the subtitle of the Indecision Application';
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            props.options.map(function (opt) {
                return React.createElement(Option, { key: opt, option: opt, handleDeleteOption: props.handleDeleteOption });
            })
        )
    );
};
...
ReactDOM.render(React.createElement(IndecisionApp, null), document.getElementById('app_root'));
